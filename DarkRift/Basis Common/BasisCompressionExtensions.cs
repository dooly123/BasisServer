...
{
    public static partial class BasisCompressionExtensions
    {
        /// <summary>
        ...
        public static Vector3 DecompressAndProcessAvatar(ServerSideSyncPlayerMessage syncMessage)
        {
          ...
          //  AvatarBuffer avatarBuffer = new AvatarBuffer();
            int Offset = 0;
            return BasisCompressionExtensions.ReadVectorFloatFromBytes(ref syncMessage.avatarSerialization.array, ref Offset);
